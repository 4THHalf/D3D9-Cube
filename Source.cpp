...
void initD3D(HWND hWnd)
{
	...
	d3dpp.AutoDepthStencilFormat = D3DFMT_D16; //16 - pixel format
...
void render_frame(void)
{
	...
	D3DXMatrixLookAtLH(&matView,
		&D3DXVECTOR3(60.0f, 20.0f, 30.0f),    // camera direction
		&D3DXVECTOR3(0.0f, 0.0f, 0.0f),     // look direction 
	...
	D3DXMatrixTranslation(&matTranslate, (float) sin (index) * 12.0f, 0.0f, (float) cos (index) * 25.0f);   
...
void init_light(void)
{
	...
	light.Diffuse = D3DXCOLOR(0.8f, 0.5f, 0.5f, 1.0f);
